...
#define TIME_BLOCK_MS (70UL * 1000UL)        // Время блокировки после распыления
...
#define SPRAY_ON_MS 1000UL         // длительность пшика (мс)
#define SPRAY_OFF_REVEVSE_MS 50UL  // пауза между пшиками (мс)
#define SPRAY_REVERSE_MS 500UL     // реверс пшика (мс)
